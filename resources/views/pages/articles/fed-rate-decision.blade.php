...
@section('title', "How the Fed's 2026 Rate Decision Will Reshape Your Strategy – FinReview")
        ...
        <div class="absolute top-8 left-0 right-0">
            <div class="max-w-screen-lg mx-auto px-6">
                <nav class="flex items-center gap-2 text-[12px] text-white/50">
                    ...
                    <span>/</span>
                    <span class="text-white/80">Fed Rate Decision 2026</span>
                </nav>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-12">
            ...
            <article class="min-w-0">
                ...
                <p class="text-[17px] text-[#1a1a1a] leading-[1.9] mb-6 font-light">
                    The Federal Reserve's next move is the most consequential financial decision of 2026 — and with a 78% market-implied probability of a 25 basis point cut by June, the question is no longer <em>if</em> rates will fall, but <em>what you should do before they do.</em>
                </p>
                ...
                <div class="grid grid-cols-3 gap-4 mb-8">
                    @foreach([
                        ['Current 30Y Rate', '6.12%', 'text-[#1a1a1a]', 'National average as of Mar 2026'],
